...
We hope you're excited for Ruby 2.0! Join the Public TestFlight [here](https://testflight.apple.com/join/EcbyojPY). The TestFlight works for iPhone, iPad, iPod touch, and Apple Watch. The Mac app is not available for Testing - as TestFlight for Mac doesn't exist _yet_. It will be available in the fall - which we're also excited to use.
