...
<Float src="/apps/Azurite.png" alt="Azurite app icon" />
...
As we [announced](https://twitter.com/Peroxaan/status/1282162813570551810) in Summer 2020, Azurite is built in SwiftUI, and will be an app that allows you to keep up with various stocks, and crypto - with a clean interface.
...
Thanks for supporting us along the way ❤️
